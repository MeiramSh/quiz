...
/* package mySecondApp-0.1.0.0 */
#ifndef VERSION_mySecondApp
#define VERSION_mySecondApp "0.1.0.0"
#endif /* VERSION_mySecondApp */
#ifndef MIN_VERSION_mySecondApp
#define MIN_VERSION_mySecondApp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mySecondApp */
...
#define CURRENT_COMPONENT_ID "mySecondApp-0.1.0.0-inplace-mySecondApp"
